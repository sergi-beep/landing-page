...
const testimonials = [
  ...
  },
  {
    ...
    results: [
      { stat: "2 employees", label: "30+ clients" },
      { stat: "4mo → 1wk", label: "time to ship" },
      { stat: "$8K+", label: "saved/mo from week one" },
    ]
  },
  {
    ...
    results: [
      { stat: "50%", label: "cost saved in 3 days" },
      { stat: "4 employees", label: "60+ clients" },
    ]
  },
  {
    ...
    results: [
      { stat: "10/10", label: "to work with" },
      { stat: "Miles ahead", label: "of competitors" },
      { stat: "100%", label: "problem solve rate" },
    ]
  },
  {
    ...
    results: [
      { stat: "2 months", label: "manual → automated" },
      { stat: "Hours/day", label: "saved across departments" },
      { stat: "Easy to Scale", label: "and easy to Sell" },
    ]
  },
  {
    ...
    results: [
      { stat: "Instant", label: "process understanding" },
      { stat: "Day 1", label: "implementation started" },
      { stat: "Super fast", label: "response time" },
    ]
  },
  {
    ...
    results: [
      { stat: "70", label: "clients managed" },
      { stat: "Month 1", label: "business impact" },
      { stat: "2-3 agencies", label: "failed before us" },
    ]
  },
  {
    ...
    results: [
      { stat: "20 clients", label: "per ops manager" },
      { stat: "Same day", label: "bug fixes" },
      { stat: "1 platform", label: "for everything" },
    ]
  },
  {
    ...
    results: [
      { stat: "30 → 60", label: "client capacity" },
      { stat: "Weekly", label: "new projects shipped" },
    ]
  },
];
        ...
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="relative">
            ...
            <div className="rounded-2xl overflow-hidden border border-gray-200 shadow-sm mb-6">
              ...
              {/* BOTTOM — results ticker + quote + author */}
              <div className="bg-white px-8 py-7">
                {/* Results ticker — pill badges with staggered entrance */}
                {testimonials[activeSlide].results && (
                  <div key={`results-${activeSlide}`} className="flex flex-wrap items-center gap-2 mb-5">
                    {testimonials[activeSlide].results.map((r, i) => (
                      <div
                        key={i}
                        className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-brand-blue/[0.06] border border-brand-blue/10 opacity-0 animate-[fadeSlideIn_0.4s_ease_forwards]"
                        style={{ animationDelay: `${i * 120}ms` }}
                      >
                        <span className="text-brand-blue font-extrabold text-[15px] tracking-tight">{r.stat}</span>
